...
<script type="text/javascript" src="static/ueditor/editor_ui_all.js"></script>
...
<p><input style="width:50px" type="text" id="order" name="order" value="<?=isset($post) ? $post['order'] : 0 ?>" />&nbsp;&nbsp;&nbsp;调整文章的显示顺序：首先按序号排序，序号相同的按发表时间排序。序号越大，代表排列越靠前。默认为0。</p>
<p><button type="submit">发表文章</button></p>
</form>
<script type="text/javascript">
    var editor = new baidu.editor.ui.Editor({textarea: 'content'});
